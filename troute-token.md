...
TROUTE is the native token of the TROUTE protocol.
...
Every token in existence is available to the public at the same price. This is a fair launch in the most literal sense of the term.
...
The token is directly tied to protocol usage. Not speculation. Not narrative. Usage.
...
$TROUTE is the governance token of the protocol. Holders vote on fee parameters, routing rules, supported assets, and protocol upgrades.

Governance is designed to be minimal at launch and expand as the protocol matures. The community controls the direction of TROUTE.
